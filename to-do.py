...
class TodoApp:
    ...
    def create_widgets(self):
        self.task_entry = tk.Entry(self.root, width=50,  font=(25))
        self.task_entry.pack(pady=10)

        self.add_task_button = ttk.Button(self.root, text="Add Task", command=self.add_task)
        self.add_task_button.pack(pady=10)

        self.tasks_listbox = tk.Listbox(self.root, width=50, height=10,  font=(25))
        ...
        self.save_tasks_button = ttk.Button(self.root, text="Save Tasks", command=self.save_tasks)
        self.save_tasks_button.pack(pady=10)

        self.load_tasks_button = ttk.Button(self.root, text="Load Tasks", command=self.load_tasks)
